    ...
    <div className="flex flex-col items-center justify-center h-screen overflow-hidden p-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSignup} className="space-y-5">
          ...
          <button
            type="submit"
            className={`w-full bg-blue-custom hover:bg-blue-custom/60 text-white font-semibold py-2.5 px-4 rounded-lg transition duration-150 ease-in-out ${
          ...
          <div className="flex justify-centre text-md pt-2">
            ...
            <Link
              href="/login" // Update link as needed
