      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input value={habitName} placeholder="Coding" onChange={(e) => setHabitName(e.target.value)} className="text-md"/>
          </div>
          <div>
            <label className="text-sm font-mediu">Description</label>
            <Input value={habitDescription} onChange={(e) => setHabitDescription(e.target.value)} className="text-md"/>
          </div>
